...
export async function onRequest(context) {
  ...
  if (
    ...
    url.pathname.startsWith("/api/naver-cafe-oauth") ||
    url.pathname.startsWith("/api/instagram-oauth") ||
    ...
    url.pathname.startsWith("/api/generate-draft") || url.pathname.startsWith("/api/generate-cafe-draft") || url.pathname.startsWith("/api/update-case") ||
