...
function buildLawFaq(landing, group, caseData) {
  ...
  const byKey = {
    la: [
      ...
      { question: "고소장 접수 후 수사는 어떻게 진행되나요?", answer: "경찰 접수 후 사건이 배당되면 진술 조사와 자료 보완 요청이 이어집니다. 계좌 추적과 피의자 특정에 시간이 걸릴 수 있으므로, 접수 이후에도 새로운 자료가 확인되면 추가 제출해야 합니다." },
    ...
    lb: [
      ...
      { question: "계좌 지급정지 신청은 어떻게 하나요?", answer: "입금한 은행에 전화하거나 영업점을 방문해 지급정지를 요청할 수 있습니다. 경찰 신고 접수번호가 있으면 처리 속도가 빨라집니다. 이체 직후 빠르게 신청할수록 잔액 보전 가능성이 높아집니다." },
    ...
    le: [
      ...
      { question: "경찰 신고와 금융감독원 신고를 함께 해야 하나요?", answer: "두 신고는 목적이 다릅니다. 경찰 신고는 피의자 처벌을 위한 형사 절차이고, 금융감독원 신고는 계좌 제한과 불법 금융행위 차단을 위한 절차입니다. 병행하면 대응 범위가 넓어집니다." },
    ],
  };
