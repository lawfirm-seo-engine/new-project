...
function layout({ title, description, canonical, body }) {
  return `<!doctype html><html lang="ko"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${esc(title)}</title><meta name="description" content="${esc(description)}"><link rel="canonical" href="${esc(canonical)}"><meta property="og:title" content="${esc(title)}"><meta property="og:description" content="${esc(description)}"><meta property="og:url" content="${esc(canonical)}"><meta property="og:type" content="article"><style>${styles()}</style></head><body><header class="site"><a href="/">법무법인 선린</a><nav><a href="/">홈</a><a href="/board/">법률정보</a></nav></header>${body}<footer>법무법인 선린 · 1688-7173</footer></body></html>`;
}
...
function styles(){return `*{box-sizing:border-box}body{margin:0;color:#18202a;font-family:Arial,'Noto Sans KR',sans-serif;background:#fff}.site{height:82px;padding:0 max(24px,calc((100% - 1180px)/2));display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #e8ebef}.site>a{font-size:24px;font-weight:800;color:#0b3146;text-decoration:none}.site nav{display:flex;gap:28px}.site nav a{color:#303a44;text-decoration:none}.hero{background:#102f42;color:#fff;padding:78px 24px}.hero>div{max-width:1180px;margin:auto}.hero span{font-size:12px;letter-spacing:2px;color:#9eb9c9}.hero h1{font-size:44px;margin:12px 0}.hero p{color:#d8e2e8}.list,.article{max-width:1040px;margin:0 auto;padding:55px 24px 90px}.list-head{display:flex;justify-content:space-between;padding-bottom:16px;border-bottom:2px solid #153e55}.row{border-bottom:1px solid #e6e9ed}.row a{display:block;padding:25px 4px;text-decoration:none;color:inherit}.row h2{font-size:22px;margin:8px 0}.row p{margin:0 0 10px;color:#64707d}.row time,.date{font-size:13px;color:#89939d}.category{font-size:12px;font-weight:800;color:#17618a}.article nav{font-size:13px;color:#7a8792;margin-bottom:32px}.article nav a,.back a{color:#164d6b}.article header{padding-bottom:30px;border-bottom:1px solid #e6e9ed}.article h1{font-size:38px;line-height:1.35;margin:10px 0 14px}.article>figure img,.content figure img{max-width:100%;height:auto}.content{font-size:17px;line-height:1.9;padding-top:35px}.content h2{font-size:27px;margin-top:48px}.content h3{font-size:22px;margin-top:38px}.content li{margin:8px 0}.back{margin-top:60px;padding-top:24px;border-top:1px solid #e6e9ed}footer{padding:35px 24px;text-align:center;background:#102f42;color:#c9d5dc;font-size:13px}.empty{padding:60px;text-align:center;color:#8a949d}@media(max-width:700px){.site{height:68px}.site nav{gap:14px}.hero{padding:55px 20px}.hero h1{font-size:34px}.article h1{font-size:30px}.list,.article{padding-left:20px;padding-right:20px}}`}
