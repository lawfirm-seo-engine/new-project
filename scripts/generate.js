...
const groups = [
  ...
  },
  {
    ...
    pathPrefix: "briefing",
    bodyClass: "domain-d",
    siteName: "AI 금융사기 브리핑",
    shortName: "AI 금융사기 브리핑",
    label: "정보형",
    intent: "사건 개요 · 대응 방법 · 정보 요약",
    ogType: "article",
    titleSuffix: "사건 정보",
    descriptionSuffix: "네이버 검색 노출을 고려해 사건 개요, 피해 구조, 대응 방법을 정보성 문체로 정리합니다.",
    ogSuffix: "사건 정보",
    hubTitle: "AI 금융사기 브리핑 피해 사건 정보 리스트",
    hubLead: "AI가 분석한 금융사기 사건 정보를 통해 피해 구조와 대응 방법을 신속하게 파악합니다.",
    tone: "정보 요약",
    ctaTitle: "사건 구조 확인",
    ctaText: "사건 개요, 피해 패턴, 증거 보존 순서를 먼저 파악한 뒤 필요한 절차를 선택합니다.",
    ctaLabel: "정보 확인",
  ...
  },
  {
    ...
    ogSuffix: "전체 허브",
    hubTitle: "금융사기 사건 통합 리스트",
    hubLead: "금융사기 피해 사건을 형사, 민사, 성공사례, 브리핑 관점으로 통합 연결합니다.",
    tone: "통합 탐색",
    ctaTitle: "유형별 대응 보기",
    ctaText: "하나의 사건을 법적 대응, 회수 절차, 사례, 정보 요약 관점으로 나누어 확인할 수 있습니다.",
    ctaLabel: "관련 정보 확인",
